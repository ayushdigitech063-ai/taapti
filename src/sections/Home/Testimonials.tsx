        ...
        <div className="google-reviews__header text-center reveal-down">
          ...
          <div className="google-reviews__logo-wrapper">
            <svg viewBox="0 -15 272 110" width="140" height="48" aria-label="Google">
              <path fill="#EA4335" d="M115.75 47.18c0 12.77-9.99 22.18-22.25 22.18s-22.25-9.41-22.25-22.18C71.25 34.27 81.24 25 93.5 25s22.25 9.27 22.25 22.18zm-9.74 0c0-7.98-5.79-13.44-12.51-13.44S80.99 39.2 80.99 47.18c0 7.84 5.79 13.44 12.51 13.44s12.51-5.6 12.51-13.44z"/>
              <path fill="#FBBC05" d="M163.75 47.18c0 12.77-9.99 22.18-22.25 22.18s-22.25-9.41-22.25-22.18c0-12.91 9.99-22.18 22.25-22.18s22.25 9.27 22.25 22.18zm-9.74 0c0-7.98-5.79-13.44-12.51-13.44s-12.51 5.46-12.51 13.44c0 7.84 5.79 13.44 12.51 13.44s12.51-5.6 12.51-13.44z"/>
